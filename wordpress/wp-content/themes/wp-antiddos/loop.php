<?php if (have_posts()): while (have_posts()) : the_post(); ?>
  <div id="post-<?php the_ID(); ?>" <?php post_class('col-md-12 col-sm-12 looper'); ?>>
    ...
    <div class="loop-post-details col-md-12 col-sm-12">
      ...
      <span class="category"><i class="fa fa-list" aria-hidden="true"></i> <?php the_category(', '); ?></span>
      <span class="tags"><i class="fa fa-tags" aria-hidden="true"></i> <?php the_tags( '', ', ', '');  ?></span>
